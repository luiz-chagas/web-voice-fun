...
export class Snake {
  ...
  constructor(scene: Phaser.Scene, voiceController: VoiceController) {
    // set variables
    this.scene = scene;
    ...
    voiceController.setOnDown(() => {
      if (this.direction !== "up") this.direction = "down";
    });
    voiceController.setOnUp(() => {
      if (this.direction !== "down") this.direction = "up";
    });
    voiceController.setOnLeft(() => {
      if (this.direction !== "right") this.direction = "left";
    });
    voiceController.setOnRight(() => {
